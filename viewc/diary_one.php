...
<div id="main">
<article>
	<header><h2><a href="<?php echo TemplateTag::url3('d', $data['post']->post_date); ?>"><?php echo $data['post']->post_title; ?></a></h2></header>
	<section>
	<p class="att">作者：<?php echo TemplateTag::authorname($data['post']->post_author); ?> 发布于：<time><?php echo $data['post']->post_date_gmt; ?></time>
	</p>

	<a class="count" href="<?php echo TemplateTag::url3('d', $data['post']->post_date); ?>#comments"><?php echo $data['post']->comment_count; ?></a>
